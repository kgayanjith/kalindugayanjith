          ...
          >
            <div className="col-lg-10">
              <div className=" container hero-text ps-md-1 ps-lg-4">
                ...
                <div>
                  <p className="tag-lilne pt-3">
                    Hi, I’m Kalindu from Sri Lanka. I create sleek, interactive
                    websites that feel alive.
                  </p>
                </div>
                <div className="btn-grp pt-5">
                  <Link to="project" className="link-tag">
                    <Button
                      label="See my Projects"
                      className="px-md-5 py-md-2 px-3 py-2 btn-custom fw-semibold me-2"
                      type="submit"
                    />
                  </Link>
                </div>
            ...
            <div className="col-lg-2 pt-5 mt-3 mt-lg-0 pt-lg-0 pe-lg-5">
              <div className="wrapper-inner d-flex text-end">
                <div className="logo-wrapper pb-0 pb-lg-4">
                  <a href="https://github.com/kgayanjith" target="_blank">
                    <img
